                ...
                <div class="card-content">
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <input type="text" name="name" id="name" class="form-control form-control-lg round" placeholder="Ex: Fundamentos do Copywriter">
                        </div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group mt-5">
                            <div class="form-check">
                                <div class="checkbox">
                                    <input name="available" type="checkbox" id="available" class="form-check-input" value="1" checked>
