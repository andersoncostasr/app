                                ...
                                <div class="accordion-item">
                                    <h2 class="accordion-header" id="flush-heading{{ $module->id }}">
                                        <button class="acc-btn accordion-button collapsed" type="button"
                                            data-bs-toggle="collapse" data-bs-target="#flush-collapse{{ $module->id }}"
                                            aria-expanded="false" aria-controls="flush-collapse{{ $module->id }}">
                                            ...
                                            <span class="options">
                                                <div class="dropdown">
                                                    ...
                                                    <div class="dropdown-menu" aria-labelledby="dropdownMenuButton"
                                                        ...
                                                        <a href="{{ route('modules.destroy', $module->id) }}"
                                                            class='dropdown-item'
                                                            onclick="event.preventDefault(); document.getElementById('destroy-module-{{ $module->id }}').submit();">
                                                            Deletar
                                                        </a>
                                                        <form id="destroy-module-{{ $module->id }}"
                                    ...
                                    <div id="flush-collapse{{ $module->id }}" class="accordion-collapse collapse"
                                        aria-labelledby="flush-heading{{ $module->id }}"
